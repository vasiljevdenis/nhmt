...
const TasksData: Test[] = [
  ...
  },
  {
    ...
    answers: [
      ...
      {
        value: 'Аппарат для получения каталитического комплекса',
        isCorrect: true
      },
      {
        value: 'Холодильник',
    ...
    content: () => {
      return (
        <>
          <Typography variant='h6' component="p" fontWeight={700} gutterBottom>Что обозначено под номером 6?</Typography>
          <Box><img src={img1} alt="Аппарат для получения каталитического комплекса" style={{ width: '100%', maxWidth: 500 }} /></Box>
        </>
      )
    }
  },
    ...
    content: () => {
      return (
        <>
          ...
          <Box><img src={img2} alt="Получение ацетилена окислительным пиролизом метана" style={{ width: '100%', maxWidth: 500 }} /></Box>
        </>
      )
    }
  }
